export function renderInvoiceHTML({ orgName, logoUri, invoiceNo, clientName, total } : {
  orgName: string; logoUri?: string; invoiceNo: string; clientName: string; total: string;
}) {
  return `
